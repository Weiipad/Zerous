...
public class Resources
{
	...
	public static ButtonSkin START_BUTTON;
	public static ButtonSkin PAUSE_BUTTON;
	public static ButtonSkin JUMP;
	public static ButtonSkin AHEAD;
	public static ButtonSkin BACK;
	public static ButtonSkin ATTACK;
	...
	public static class PlayerAnimation
	{
		...
		{
			playerFrames = loadMap("player.png", 16, Info.GAME_ZOOM, Info.GAME_ZOOM);
		}
	}
	...
	public static class Blocks
	{
		...
		public static void init()
		{
			blockList = loadMap("blocks/terrain2.png", 16, Info.GAME_ZOOM, Info.GAME_ZOOM);
		}
	}
	...
	public static void init()
	{
		START_BUTTON = new ButtonSkin(FileLoader.loadBitmapFromAssets("gui/start_up.png", Info.GUI_ZOOM), FileLoader.loadBitmapFromAssets("gui/start_down.png", Info.GUI_ZOOM));
		PAUSE_BUTTON = new ButtonSkin(FileLoader.loadBitmapFromAssets("gui/pause_up.png", Info.GUI_ZOOM), FileLoader.loadBitmapFromAssets("gui/pause_down.png", Info.GUI_ZOOM));
		...
		AHEAD = new ButtonSkin(FileLoader.loadBitmapFromAssets("gui/control/ahead.png", Info.GUI_ZOOM * 1.6f));
		BACK = new ButtonSkin(FileLoader.loadBitmapFromAssets("gui/control/back.png", Info.GUI_ZOOM * 1.6f));
		JUMP = new ButtonSkin(FileLoader.loadBitmapFromAssets("gui/control/jump.png", Info.GUI_ZOOM * 1.6f));
		ATTACK = new ButtonSkin(FileLoader.loadBitmapFromAssets("gui/control/attack.png", Info.GUI_ZOOM * 1.6f));
		LOGO = FileLoader.loadBitmapFromAssets("gui/logo.png", Info.GUI_ZOOM * 2);
		TILE_PLACER = FileLoader.loadBitmapFromAssets("gui/tileplacer.png", Info.GAME_ZOOM);


		A_PIXEL = FileLoader.loadBitmapFromAssets("gui/apixel.png", Info.GUI_ZOOM);
		Info.PIXEL_SIZE = A_PIXEL.getWidth();
		BLOCK_BASIC = FileLoader.loadBitmapFromAssets("blockbasic.png", Info.GAME_ZOOM);
	...
	public static ButtonSkin scale(ButtonSkin bs, float x, float y)
	{
		Matrix m = new Matrix();
		m.postScale(x, y);
		return new ButtonSkin(Bitmap.createBitmap(bs.getUp(), 0, 0, bs.getWidth(), bs.getHeight(), m, false), Bitmap.createBitmap(bs.getDown(), 0, 0, bs.getWidth(), bs.getHeight(), m, false));
	}
}
